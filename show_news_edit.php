<?php
	...
	function read_news(){
		...
		$stmt = $conn -> prepare("SELECT vr21_news.vr21_news_id, vr21_news.vr21_news_title, vr21_news.vr21_news_content, vr21_news.vr21_news_author, vr21_news.vr21_news_added, vr21_news_photos.vr21_news_photos_filename, vr21_news_photos.vr21_news_photos_filename
		...
		$stmt -> bind_result($news_id_from_db, $news_title_from_db, $news_content_from_db, $news_author_from_db, $news_date_from_db, $news_photo_from_db, $photos_alttext);
		...
		while ($stmt -> fetch()) {
			...
			$raw_news_html .= '<p class="links"><a href="add_news_photo_edit.php?news_id=' .$news_id_from_db .'">Muuda uudist</a></p>';
			$raw_news_html .= "</p>";
		};
		$stmt -> close();
		$conn -> close();
